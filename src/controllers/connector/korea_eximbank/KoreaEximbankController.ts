...
export class KoreaEximbankController {
   ...
   */
  @Standalone()
  @RouteIcon("https://ecosystem-connector.s3.ap-northeast-2.amazonaws.com/icon/korea-government.svg")
  @core.TypedRoute.Get("exchange")
  async getExchange(): Promise<Try<IKoreaEximbank.IGetExchangeOutput>> {
    const data = await retry(() => KoreaEximbankProvider.getExchange())();
