...
export namespace IKakaoNavi {
  ...
  export namespace Route {
    export type Code =
      ...
      | tags.Constant<104, { title: "출발지와 도착지가 5 m 이내로 설정된 경우 경로를 탐색할 수 없음" }>
      ...
      | tags.Constant<205, { title: "다중 출발지: 출발지 주변의 유고 정보(교통 장애)로 인한 통행 불가" }>
      | tags.Constant<206, { title: "다중 출발지: 목적지 주변의 유고 정보(교통 장애)로 인한 통행 불가" }>
