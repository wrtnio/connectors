 ...
 * @module api.functional.connector.google_ads.campaigns
 ...
 * @summary 캠페인을 수정해요
 *
 * @controller GoogleAdsController.updateCampaign
 * @path PATCH /connector/google-ads/campaigns
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export async function updateCampaign(
  connection: IConnection,
  input: updateCampaign.Input,
): Promise<void> {
  return !!connection.simulate
    ? updateCampaign.simulate(connection, input)
    : PlainFetcher.fetch(
        {
          ...connection,
          headers: {
        ...
        },
        {
          ...
          path: updateCampaign.path(),
        },
        input,
      );
}
export namespace updateCampaign {
  export type Input = Primitive<IGoogleAds.IUpdateCampaignInput>;

  export const METADATA = {
    method: "PATCH",
    path: "/connector/google-ads/campaigns",
    request: {
  ...
  export const path = () => "/connector/google-ads/campaigns";
  export const random = (
 ...
 * @path POST /connector/google-ads/campaigns
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
