...
export namespace appendAd {
  ...
  export type Output = Primitive<IGoogleAds.IGetAdGroupsOutputResult>;
  ...
  ): Resolved<Primitive<IGoogleAds.IGetAdGroupsOutputResult>> =>
    typia.random<Primitive<IGoogleAds.IGetAdGroupsOutputResult>>(g);
