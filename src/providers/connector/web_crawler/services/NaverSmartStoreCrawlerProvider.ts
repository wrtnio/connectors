...
export namespace NaverSmartStoreCrawlerProvider {
  export const crawl = async (
    ...
    const $ = await CommonExtractor.fetchPage(
      request,
      `[
          { "click": "#_productFloatingTab > div > div._27jmWaPaKy._1dDHKD1iiX > ul > li:nth-child(2) > a" },
  ...
  const extractReviews = ($: CheerioAPI): INaver.Review[] => {
    ...
    console.log(
      $(
        "#REVIEW > div > div._2LvIMaBiIO > div._2g7PKvqCKe > ul > li:nth-child(1)",
      ).text(),
    );
