 ...
 */
export async function test_api_story_image(connection: CApi.IConnection): Promise<IStoryImage> {
  const result = await CApi.functional.connector.story_image_generator.generateImage(connection, {
