...
export async function test_selector_llm(connection: CApi.IConnection): Promise<ISelectorLlmResponse> {
  const generated = await CApi.functional.connector.llm.selector_llm.selectorLlm(connection, {
    candidates: [
