...
export const test_api_kakao_talk_send_message = async (connection: CApi.IConnection) => {
  /**
   * 텍스트 메시지 발송.
   */
  const sendTextForm = await CApi.functional.connector.kakao_talk.message.text.send(connection, {
